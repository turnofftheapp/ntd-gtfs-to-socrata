...
from six import string_types #Adding this line because basestring is throwing an error. I am going to replace basestring usage below (one spot) with variable "string_types"
