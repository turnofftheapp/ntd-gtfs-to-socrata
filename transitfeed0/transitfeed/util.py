...
import sys
import time
# import urllib2 replacing this with the below import command due to urllib2 not being found. I found a possible reason here https://stackoverflow.com/questions/2792650/import-error-no-module-name-urllib2
import urllib # I then found urllib2 being called in 4 spots in this file, and deleted the 2 from it to see if this will work
...
def CheckVersion(problems, latest_version=None):
  ...
  if not latest_version:
    ...
    request = urllib.Request(LATEST_RELEASE_VERSION_URL)
